document.addEventListener('DOMContentLoaded', function() {
    ...
    const navbarWrapper = document.getElementById('mainListDiv');
...
const NEWS_API_URL = 'https://newsapi.org/v2/everything?q=Business&from=2023-11-15&sortBy=popularity&apiKey=d31bd4f44a6b4d96bb34b43396382429';
...
async function updateNews(newsData) {
    ...
    filteredNews.forEach((article) => {
        ...
        const safeAuthor = (author || '').toLowerCase(); // Handle undefined author
